...
const ServiceForm = ({ onSuccess }) => {
  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow-md max-w-2xl mx-auto mt-8">
      <h2 className="text-2xl font-bold mb-4 text-cyan-700">Add New Service</h2>
      {error && <div className="mb-4 text-red-600 font-semibold">{error}</div>}
      {success && <div className="mb-4 text-green-600 font-semibold">Service added successfully!</div>}
